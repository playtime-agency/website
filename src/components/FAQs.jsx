...
const FAQs = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer:
        " We start by understanding our clients goals, target audience, and market landscape. We then develop tailored strategies that combine creativity, data driven insights, and industry best practices. Our collaborative approach ensures transparency, effective communication, and measurable results throughout the project lifecycle.",
    },
    {
      question: "What sets your agency apart from others?",
      answer:
        "Our agency stands out due to our innovative solutions, experienced team of experts, and commitment to delivering tangible results. We prioritize creativity, strategic thinking, and continuous optimization to drive growth and exceed client expectations. Additionally, our client-centric approach fosters long-term partnerships built on trust and mutual success.",
    },
    {
  ...
  return (
    ...
    >
      <Fade cascade triggerOnce duration={500}>
        ...
        <Typography
          variant="h2"
          sx={{ fontFamily: "Poppins", color: "#c9c7c7" }}
        >
        ...
        {questions.map((item, index) => (
          <Accordion
            ...
            sx={{
              marginBottom: "1rem",
              backgroundColor:
                selectedQuestion === index ? "#212427" : "transparent",
              border:
          ...
          >
            ...
            >
              <Typography
                variant="h5"
                sx={{ fontFamily: "Inter", color: "#c9c7c7", mb: "2rem" }}
              >
                {item.question}
              </Typography>
            </AccordionSummary>
        ...
        >
          ...
          <Link
            to="/contactUs"
            style={{ color: "#00c062", textDecoration: "none" }}
          >
            Contact Us
          </Link>
        </Typography>
