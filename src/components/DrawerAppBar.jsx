...
const navItemsLeft = [
  ...
  { title: "Testimonials", path: "/#portfolioSec" },
...
function DrawerAppBar(props) {
  ...
  const drawer = (
    <Box
      ...
      sx={{ textAlign: "center", transition: "top 2.5s ease" }}
    >
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        sx={{
          backgroundColor: darkMode ? "inherit" : "#f6fbf6",
          boxShadow: "none",
          mt: "25px",
        }}
      >
              ...
              >
                <ListItemButton
                  sx={{
                    ...
                    py: "18px",
                    textAlign: "center",
                    color: darkMode ? "#c9c7c7" : "white",
                    backgroundColor: darkMode ? "#212427" : "black",
                    border: "1px solid #383839",
                    borderRadius: "35px",
                    transition: "background-color 0.3s ease",
                    "&:hover": { backgroundColor: "#00c062" },
                    "&:active": { backgroundColor: "#00c062" },
                    fontFamily: "Inter",
                    fontSize: "1rem",
                  }}
                >
